...
VALUES (11101, '8 flat fee wire transfer', 'FLAT_FEE', 'WIRE_TRANSFER', 8.0, 'ORIGIN', 1951, 'admin', current_timestamp(), 'admin', current_timestamp()),
    ...
    (11104, '1.35% withdraw fee', 'PERCENTAGE', 'WITHDRAW', 1.35, 'DESTINTION', 1952, 'admin', current_timestamp(), 'admin', current_timestamp()),
    (11105, '0.0025% transaction fee', 'PERCENTAGE', 'SELL', 0.0025, 'ORIGIN',  1952, 'admin', current_timestamp(), 'admin', current_timestamp());

INSERT INTO CHARGE_ASSET (ASSETS_ID, CHARGES_ID)
VALUES (11051,  11101), (11051, 11103), (11051, 11104), (11052, 11102), (11052, 11105), (11053, 11102), (11053, 11105);
...
VALUES (1951, 'Bank Account - BRL - FLAT', 10000.0, 'FLAT', 'OPEN', 11051, 11202, 'admin', current_timestamp(), 'admin', current_timestamp()),
    ...
    (1954, 'Exchange  - LTC - LONG', 0.0, 'LONG', 'OPEN', 11053, 11201, 'admin', current_timestamp(), 'admin', current_timestamp());
