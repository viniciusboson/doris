...
class OperationGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Operation entity")
        ...
        .repeat(2) {
            ...
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "createdAt":"2020-01-01T00:00:00.000Z", "updatedAt":"2020-01-01T00:00:00.000Z", "executedAt":"2020-01-01T00:00:00.000Z", "amountFrom":null, "amountTo":null}""")).asJSON
            .check(status.is(201))
