...
public class OperationResourceIntTest {
    ...
    private static final OperationType DEFAULT_OPERATION_TYPE_FROM = OperationType.WIRE_TRANSFER;
    private static final OperationType UPDATED_OPERATION_TYPE_FROM = OperationType.WITHDRAW;

    private static final OperationType DEFAULT_OPERATION_TYPE_TO = OperationType.WIRE_TRANSFER;
    ...
    public static Operation createEntity(EntityManager em) {
        Operation operation = new Operation()
            ...
            .operationTypeFrom(DEFAULT_OPERATION_TYPE_FROM)
            .operationTypeTo(DEFAULT_OPERATION_TYPE_TO);
        // Add required entity
