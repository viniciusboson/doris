...
public class Institution implements Serializable {
    ...
    public Institution createdAt(ZonedDateTime createdAt) {
    ...
    public Institution updatedAt(ZonedDateTime updatedAt) {
    ...
    public Institution modifiedBy(String modifiedBy) {
